...
public final class BPJSCekNoRujukanPCare extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-04-2022" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-04-2022" }));
        ...
        CmbKlg.setBounds(534, 115, 155, 23);
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-04-2022 09:22:17" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-04-2022" }));
        ...
        LakaLantas.setBounds(589, 25, 101, 23);
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "13-04-2022" }));
            ...
            if(nameNode.path("code").asText().equals("200")){
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        CmbKlg.setSelectedItem(rs.getString("namakeluarga"));
                        if(tampilkantni.equals("Yes")){
    ...
    private void inputRegistrasi(){
        ...
        if(JenisPelayanan.getSelectedIndex()==1){
            ...
            if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",20,
                    ...
                    CmbKlg.getSelectedItem().toString(),TBiaya.getText(),"Belum",statuspasien,"Ralan",Kdpnj.getText(),umurdaftar,sttsumur,"Belum Bayar",status,"-"
                })==true){
                    UpdateUmur();
            ...
            if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",20,
                    ...
                    CmbKlg.getSelectedItem().toString(),Sequel.cariIsi("select registrasilama from poliklinik where kd_poli='IGDK'"),"Belum",statuspasien,"Ralan",Kdpnj.getText(),umurdaftar,sttsumur,"Belum Bayar",status,"-"
                })==true){
                    UpdateUmur();
                    Sequel.menyimpan2("rujuk_masuk","'"+TNoRw.getText()+"','"+NmPpkRujukan.getText()+"','"+Kabupaten.getText()+"','"+NoRujukan.getText()+"','0','"+NmPPK.getText()+"','"+KdPenyakit.getText()+"','-','-','"+NoBalasan.getText()+"'","No.Rujuk");                                     
                    Sequel.menyimpan3("penyakit","?,?,?,?,?,?","Penyakit",6,new String[]{KdPenyakit.getText(),NmPenyakit.getText(),NmPenyakit.getText(),"-","-","Tidak Menular"});
