...
public final class BPJSCekRujukanKartuPCare extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        CMbGd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CMbGdActionPerformed(evt);
            }
        });
        ...
        FormKelengkapanPasien.add(CmbKlg);
        CmbKlg.setBounds(534, 115, 138, 23);
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-04-2021 14:46:43" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-04-2021" }));
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-04-2021" }));
    ...
    private void CmbKlgKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKlgKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKlgKeyPressed

    private void CMbGdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CMbGdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CMbGdActionPerformed
    ...
    */
    ...
    private widget.ComboBox CmbKlg;
            ...
            if(nameNode.path("code").asText().equals("200")){
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        DTPLahir.setSelectedItem(rs.getDate("tgl_lahir"));
                        ...
                        CmbKlg.setSelectedItem(rs.getString("keluarga"));
                        if(tampilkantni.equals("Yes")){
    ...
    private void insertPasien() {
        ...
        if(statuspasien.equals("Baru")){
            ...
            if(Sequel.menyimpantf2("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                    ...
                    TTlp.getText(),TUmur.getText(),CMbPnd.getSelectedItem().toString(),CmbKlg.getSelectedItem().toString(),Saudara.getText(),Kdpnj.getText(),TNoPeserta.getText(),
    ...
    private void inputRegistrasi(){
        ...
        if(JenisPelayanan.getSelectedIndex()==1){
            ...
            if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",19,
                    ...
                    CmbKlg.getSelectedItem().toString(),TBiaya.getText(),"Belum",statuspasien,"Ralan",Kdpnj.getText(),umur,sttsumur,"Belum Bayar",status
                })==true){
                    UpdateUmur();
                    if(nosisrute.equals("")){
            ...
            if(Sequel.menyimpantf2("reg_periksa","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",19,
                    ...
                    CmbKlg.getSelectedItem().toString(),Sequel.cariIsi("select registrasilama from poliklinik where kd_poli='IGDK'"),"Belum",statuspasien,"Ralan",Kdpnj.getText(),umur,sttsumur,"Belum Bayar",status
                })==true){
                    UpdateUmur();
                    if(nosisrute.equals("")){
                        Sequel.menyimpan2("rujuk_masuk","'"+TNoRw.getText()+"','"+NmPpkRujukan.getText()+"','"+Kabupaten.getText()+"','"+NoRujukan.getText()+"','0','"+NmPPK.getText()+"','"+KdPenyakit.getText()+"','-','-','"+NoBalasan.getText()+"'","No.Rujuk");             
